...
public class StudentFeeForm extends JFrame implements ActionListener {
    ...
    StudentFeeForm() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/dolor.png"));
        Image i2 = i1.getImage().getScaledInstance(500, 548, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(400, 0, 500, 500);
        add(image);
        
        JLabel lblrollnumber = new JLabel("Select ID");
        ...
        String course[] = { "CSE", "PHARMACY", "BBA", "ENGLISH", "LLB"};
        ...
        update.setBounds(50, 380, 100, 25);
